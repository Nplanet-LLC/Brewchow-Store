      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className="bg-[#F5F1E8] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all hover:scale-105 animate-scaleIn hover-lift"
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="relative mb-4">
                  <Image src="/icons/quote.svg" alt="" width={32} height={32} className="opacity-30" />
                </div>
